...
// ═══════════════════════════════════════════════════════════════════════════════
// College Admin - Competition Detail/Manage Page
// View and manage a specific competition
// ═══════════════════════════════════════════════════════════════════════════════
...
export default function CollegeCompetitionDetailPage({
  params
}: {
    ...
    async function fetchData() {
      try {
        ...
        if (compData.success) {
          ...
          router.push('/college/competitions');
          return;
        }

        const lbRes = await fetch(`/api/competitions/${competitionId}/leaderboard?limit=20`);
