...
export default function NotificationsPage() {
  ...
  /* ---------- Colors ---------- */
  const pageBg = isLight ? '#F8FAFC'  : '#0D0F1A';
  const cardBg = isLight ? '#FFFFFF'  : '#161B2E';
  const border = isLight ? '#E5E7EB'  : 'rgba(255,255,255,0.08)';
  const text   = isLight ? '#0F0B2E'  : '#F1F5F9';
    ...
    <MobileNavShell activeHref="/notifications">
      <div style={{ background: pageBg, minHeight: '100%' }}>
        ...
        <div style={{
          ...
          background: isLight ? 'rgba(248,250,252,0.96)' : 'rgba(22,27,46,0.96)',
          ...
          {unreadCount > 0 && (
            <button
              ...
              style={{
                ...
                fontSize: 11, fontWeight: 700, border: '1px solid rgba(124,58,237,0.3)', cursor: 'pointer',
              }}
            >
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      ...
                      <span style={{ fontSize: 11, color: '#A78BFA', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 2 }}>
