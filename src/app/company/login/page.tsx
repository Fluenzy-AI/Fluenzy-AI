      ...
      <div className="flex-1 flex flex-col min-h-screen bg-[#080d1a] overflow-y-auto">
        ...
        <div className="border-b border-white/10 bg-[#0b1222]/80 px-5 py-4 backdrop-blur-xl lg:hidden">
          <div className="flex items-center justify-between">
            ...
            <Link href="/company-portal" className="rounded-lg border border-white/15 px-3 py-2 text-xs font-bold text-slate-300">Partner portal</Link>
          </div>
          <Link href="/" className="mt-4 inline-flex items-center gap-1.5 text-sm text-slate-400 transition-colors hover:text-white">
            <ArrowLeft className="h-4 w-4" /> Back to Fluenzy AI
          </Link>
        </div>

        <div className="flex-1 flex items-center justify-center px-4 py-8 sm:px-6 lg:py-12">
          <div className="w-full max-w-md">
            ...
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-xl shadow-indigo-500/25 flex-shrink-0">
              ...
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-white">Company Partner Login</h2>
