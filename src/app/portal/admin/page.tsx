...
const ADMIN_NAV = [
  ...
  { label: "Competitions", href: "/portal/admin/competitions", icon: <TrophyIcon /> },
...
function TrophyIcon() { return <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className="w-full h-full"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15l-2 5H6l3-7h0a5 5 0 01-4-4.9V4h14v4.1a5 5 0 01-4 4.9h0l3 7h-4l-2-5zm-6-11v4.1a3 3 0 002.8 3H12m6-7v4.1a3 3 0 01-2.8 3H12m0 0v3" /></svg>; }
