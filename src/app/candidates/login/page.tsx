    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-2xl">
          ...
          {/* Google Sign In */}
          <a
            href={`/api/candidates/auth/google?redirect=${encodeURIComponent(redirect)}`}
            className="flex items-center justify-center gap-3 w-full py-2.5 border border-border rounded-xl bg-background text-foreground text-sm font-semibold hover:bg-white/5 hover:border-white/30 transition mb-5"
          >
