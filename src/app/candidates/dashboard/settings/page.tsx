          ...
          <form onSubmit={handlePasswordChange} className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <button
                type="submit"
                disabled={saving}
                className="px-4 py-2 rounded-xl bg-violet-500 text-white text-sm font-semibold hover:bg-violet-400 disabled:opacity-60 transition-colors"
              >
      ...
      <div className="bg-[#13161E] rounded-xl border border-white/5 p-6">
        ...
        <div className="space-y-3">
          <button
            ...
            className="flex items-center gap-3 w-full p-3 rounded-xl text-left hover:bg-white/5 transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center gap-3 w-full p-3 rounded-xl text-left hover:bg-red-500/5 transition-colors"
          >
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <motion.div
            ...
            className="bg-[#13161E] border border-white/10 rounded-2xl w-full max-w-md p-6"
          >
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-2.5 rounded-xl border border-white/10 text-white text-sm font-medium hover:bg-white/5 transition-colors"
              >
                Cancel
              </button>
              <button
                onClick={handleDeleteAccount}
                className="flex-1 px-4 py-2.5 rounded-xl bg-red-500 text-white text-sm font-semibold hover:bg-red-400 transition-colors"
              >
                Delete Account
              </button>
            </div>
